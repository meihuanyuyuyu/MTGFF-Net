...
class CenterROIHeads(ROIHeads):
    ...
    def _init_mask_head(self, cfg):
        ...
        pooler_type       = cfg.MODEL.ROI_MASK_HEAD.POOLER_TYPE#v2
        ...
        self.mask_pooler = ROIPooler(
            ...
            canonical_box_size=cfg.MODEL.ROI_MASK_HEAD.CANONICAL_SIZE,
        )
    ...
    def _forward_mask(
        ...
        if self.training:
            ...
            if self.maskiou_on:
                ...
                return {
                    "loss_mask": mask_rcnn_loss(mask_logits, proposals, self.maskiou_on)
                }
        else:
    ...
    def _forward_maskiou(
        ...
        if self.training:
            ...
            return {
                "loss_maskiou": mask_iou_loss(
                    labels, pred_maskiou, maskiou_targets, self.maskiou_weight
                )
            }
