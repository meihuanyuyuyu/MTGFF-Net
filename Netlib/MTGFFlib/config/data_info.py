...
class CONIC(object):
    classes = 7
    dataset_dir = "data/conic"
    def __init__(self,split_num):
        self.ds_index = torch.load(f"splitted_index/conic_splitted_indices.pt")
        self.split_sets_path = f"splitted_index/conic_splitted_indices.pt"
...
class PANNUKE(object):
    ...
    def __init__(self,split_num):
        self.ds_index = torch.load(f"splitted_index/pannuke_splitted_indices.pt")
        self.split_sets_path = f"splitted_index/pannuke_splitted_indices.pt"
